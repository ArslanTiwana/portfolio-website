...
export default function CurrentLearningSection() {
  ...
  return (
    <section id="current-learning" className="py-20 bg-gradient-to-br from-slate-50 to-blue-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-slate-600 max-w-3xl mx-auto">
            I believe in learning by building — and everything I learn, I try to apply in real projects.
          </p>
        </div>
          ...
          <Card className="bg-gradient-to-r from-emerald-500 to-blue-500 text-white">
            <CardContent className="p-8 text-center">
              ...
              <p className="text-lg opacity-90 max-w-3xl mx-auto">
                I'm currently diving deep into cutting-edge technologies that shape the future of scalable backend systems. 
                My approach is hands-on: I don't just read about these technologies—I build projects with them.
              </p>
            </CardContent>
          </Card>
        </div>
