  ...
  const experiences = [
    {
      ...
      techColors: ["bg-orange-600", "bg-blue-600", "bg-purple-600", "bg-green-600"],
      achievements: [
        "Worked on production-grade Shopify apps for discount engine, pricing logic, checkout customization",
    ...
    },
    {
      ...
      achievements: [
        ...
        "Delivered over 180 hours of freelance NestJS work"
      ]
    }
  ];
            ...
            <Card key={index} className="bg-slate-800 border-slate-700 hover:bg-slate-700 transition-colors">
              <CardContent className="p-8">
                <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-6">
                  ...
                  <div className="text-right mt-4 md:mt-0">
                    <Badge 
                      ...
                      className={exp.status === "current" ? "bg-emerald-600 text-white" : "bg-blue-600 text-white"}
                    >
                      {exp.period}
                    </Badge>
                  </div>
                ...
                {exp.technologies.length > 0 && (
                  <div className="mb-6">
                    <h4 className="text-lg font-semibold mb-3 text-slate-200">Tech Stack:</h4>
                    ...
                    <li key={achIndex} className="flex items-start">
                      ...
                      <span dangerouslySetInnerHTML={{
                        __html: achievement
                          ...
                          .replace(/Rust/g, '<strong class="text-orange-400">Rust</strong>')
                          .replace(/React \+ GraphQL/g, '<strong class="text-blue-400">React + GraphQL</strong>')
                          .replace(/NestJS \+ PostgreSQL/g, '<strong class="text-emerald-400">NestJS + PostgreSQL</strong>')
                          .replace(/180 hours/g, '<strong class="text-emerald-400">180 hours</strong>')
                      }} />
                    </li>
                  ))}
                </ul>
