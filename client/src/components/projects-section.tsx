...
export default function ProjectsSection() {
  ...
  const docFeatures = [
    ...
    {
      icon: "📄",
      title: "Release-wise .md tracking for architecture, ERDs, APIs, deployment"
    },
    {
      icon: "👥",
        ...
        <Card className="bg-white rounded-2xl shadow-xl overflow-hidden">
          <div className="md:flex">
            <div className="md:w-1/2 p-8 md:p-12">
              <div className="mb-6">
                <h3 className="text-3xl font-bold mb-4 text-slate-900">TiwanaConnect</h3>
                <p className="text-lg text-slate-600 mb-6">
                  A high-quality, real-world full-stack app to manage extended family lineage, designed for <strong className="text-blue-600">400+ members</strong>.
                </p>
                <div className="bg-blue-50 p-4 rounded-lg mb-6">
                  <p className="text-sm text-blue-800">
                    📦 <strong>Full release planned for 2025</strong> as a family-facing product
                  </p>
                </div>
              </div>
              ...
              <div className="space-y-6">
                {features.map((feature, index) => (
                  <div key={index} className={`border-l-4 ${feature.color} pl-4`}>
            ...
            <div className="md:w-1/2 bg-gradient-primary p-8 md:p-12 text-white">
              <h4 className="text-2xl font-bold mb-6">Documentation & Architecture</h4>
                    ...
                    <div>
                      <span dangerouslySetInnerHTML={{
                        __html: feature.title
                          .replace(/Docusaurus/g, '<strong>Docusaurus</strong>')
              ...
              <div className="mt-8 p-4 bg-white/10 rounded-lg">
                <p className="text-sm">
                  <strong>Tech Highlights:</strong> Event-driven architecture, Real-time updates, Complex relationship mapping, Role-based access control
                </p>
              </div>
            </div>
          </div>
